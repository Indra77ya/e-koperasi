        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <!-- ASSETS -->
                    <div class="col-md-6">
                        <h4 class="text-uppercase text-muted font-weight-bold">Assets</h4>
                    ...
                    <!-- LIABILITIES & EQUITY -->
                    <div class="col-md-6">
                        <h4 class="text-uppercase text-muted font-weight-bold">Liabilities</h4>
                        <table class="table table-sm">
                        ...
                        <h4 class="text-uppercase text-muted font-weight-bold mt-4">Equity</h4>
                        <table class="table table-sm">
                            ...
                            @endforeach
                            <tr>
                                <td>Current Earnings (Laba/Rugi Berjalan)</td>
