            ...
            <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="2" class="form-control{{ $errors->has('info_bisnis') ? ' is-invalid' : '' }}" name="info_bisnis">{{ old('info_bisnis') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control{{ $errors->has('status_risiko') ? ' is-invalid' : '' }}" name="status_risiko">
                            <option value="safe" {{ old('status_risiko') == 'safe' ? 'selected' : '' }}>Aman</option>
                            <option value="warning" {{ old('status_risiko') == 'warning' ? 'selected' : '' }}>Peringatan</option>
                            <option value="blacklist" {{ old('status_risiko') == 'blacklist' ? 'selected' : '' }}>Blacklist</option>
                        </select>
